...
import com.songmingyu.admin.web.domain.posts.PostsRepositoryTest;
...
public class PostsApiControllerTest {
    ...
    public void Posts_ADD() throws  Exception {
        ...
        //when
        ResponseEntity<Long> responseEntity = restTemplate.postForEntity(url,requestDto,Long.class); //post 연결
