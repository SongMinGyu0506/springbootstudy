...
// 해당 인터페이스는 조건에 맞는 경우 메소드가 있다면 HandlerMethodArgumentResolver의 구현체가 지정한 값으로 해당 메소드의 파라미터로 넘김
...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    //여기서는 파라미터에 @LoginUser 어노테이션이 붙어있고 파라미터 클래스 타입이 SessionUser.class인경우 true 반환
